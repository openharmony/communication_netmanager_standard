...
#ifndef NET_POLICY_EVENT_LISTENER_MANAGER_H
#define NET_POLICY_EVENT_LISTENER_MANAGER_H
...
class NetPolicyEventListenerManager {
public:
    static NetPolicyEventListenerManager& GetInstance();
...
private:
    NetPolicyEventListenerManager();
    std::shared_ptr<NetPolicyEventListenerHandler> eventListenerHandler = nullptr;
    std::shared_ptr<AppExecFwk::EventRunner> eventLoop = nullptr;
    EventHandleRun eventStateRun_ = STATE_NOT_START;
};
} // namespace NetManagerStandard
} // namespace OHOS
#endif // NET_POLICY_EVENT_LISTENER_MANAGER_H